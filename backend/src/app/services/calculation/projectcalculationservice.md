...
- Der **Readiness-Faktor** erhöht den Aufwand, wenn die Vorbereitung schlecht ist (Formel: `1 + (0,5 – Readiness)`). Bei sehr schlechter Vorbereitung unter 30 % kommt zusätzlich ein Strafaufschlag von 20 % hinzu.
...
Aus dem Aufwand in Personenwochen wird die kalendarische Dauer berechnet. Dafür wird der Gesamtaufwand durch die Teamgröße multipliziert mit einem Produktivitätsfaktor geteilt. Der Produktivitätsfaktor liegt standardmäßig bei 0,6 – das bedeutet, dass ein Teammitglied in der Praxis nur 60 % seiner Zeit direkt produktiv am Projekt arbeitet, der Rest fällt für Meetings, Abstimmungen und andere Tätigkeiten an. Das Ergebnis wird aufgerundet, da eine Projektwoche immer eine ganze Woche ist.
